...
<html lang="en">
    ...
    <div class="content">
        ...
        <div class="tek_caf">
            <img id="tek" class="tek_img" src="../images/tek_cafeteria_img.png" width="167px" height="122px">
            <p>Tek-Cafeteria</p>
        </div>
        <div class="big_caf">
            <img class="big_img" src="../images/big_cafeteria_img.png" width="167px" height="122px">
            <p>The Big Cafeteria</p>
        </div>
        <div class="small_caf">
            <img class="small_img" src="../images/small_cafeteria_img.png" width="167px" height="122px">
